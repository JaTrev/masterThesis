...
def prepare_data(task_data_path, transcription_path) -> dict:
    ...
    """
    # Reading transcriptions on SEGMENT-level, sep. in train, devel, test of the offical challenge
...
data = prepare_data(task_data_path='data/processed_tasks/c2_muse_topic',
